...
export const App = () => {
  return (
    ...
    >
      ...
      <Resource name="glashersteller" list={GlashersstellerList} show={GlashersstellerShow} />
      <Resource name="glaskatalog" list={GlaskatalogList} show={GlaskatalogShow} />
      <Resource name="glaskatalog_option" list={GlaskatalogOptionList} show={GlaskatalogOptionShow} />
      ...
      <Resource name="termin" list={TerminList} show={TerminShow} edit={TerminEdit} create={TerminCreate} icon={EventIcon} />
      <CustomRoutes>
