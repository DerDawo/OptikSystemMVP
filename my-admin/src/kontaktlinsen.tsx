...
export const KontaktlinseList = () => (
    <List title="Kontaktlinsen" perPage={5} pagination={<Pagination rowsPerPageOptions={[5]} />}>
        <DataTable>
    ...
    <Show>
        <ShowLayout>
            ...
            <ShowSection title="Auftragsdaten">
                <Field><ReferenceField source="kunde_id" reference="kunde" link="show" /></Field>
                <Field><TextField source="Berater" /></Field>
                <Field><DateField source="Datum" /></Field>
                <Field><DateField source="Abholung" /></Field>
                <Field><DateField source="Nachkontrolltermin" /></Field>
                <Field><TextField source="Notizen" /></Field>
            </ShowSection>
            <ShowSection title="Kontaktlinse Links">
                <Field><TextField source="LinsentypLinks" /></Field>
                <Field><NumberField source="RadiusLinks" /></Field>
                <Field><NumberField source="DurchmesserLinks" /></Field>
                <Field><NumberField source="SphLinks" /></Field>
                <Field><NumberField source="CylLinks" /></Field>
                <Field><NumberField source="AchseLinks" /></Field>
                <Field><TextField source="MaterialLinks" /></Field>
                <Field><TextField source="HerstellerLinks" /></Field>
                <Field><TextField source="TragemodusLinks" /></Field>
                <Field><NumberField source="PreisLinks" /></Field>
            </ShowSection>
            <ShowSection title="Kontaktlinse Rechts">
                <Field><TextField source="LinsentypRechts" /></Field>
                <Field><NumberField source="RadiusRechts" /></Field>
                <Field><NumberField source="DurchmesserRechts" /></Field>
                <Field><NumberField source="SphRechts" /></Field>
                <Field><NumberField source="CylRechts" /></Field>
                <Field><NumberField source="AchseRechts" /></Field>
                <Field><TextField source="MaterialRechts" /></Field>
                <Field><TextField source="HerstellerRechts" /></Field>
                <Field><TextField source="TragemodusRechts" /></Field>
                <Field><NumberField source="PreisRechts" /></Field>
            </ShowSection>
...
export const KontaktlinseCreate = () => {
    ...
    return (
        <Create transform={data => ({ ...data, created_at: new Date().toISOString() })}>
